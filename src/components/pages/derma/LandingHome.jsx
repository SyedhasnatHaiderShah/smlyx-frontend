...
import bg from "../../../assets/derma.jpg";
        ...
        <div className=" lg:w-2/3 w-full h-full flex items-start justify-start  flex-col gap-5 px-5">
          <div className=" flex flex-col items-start justify-start gap-3 ">
            <p className="md:text-5xl text-xl sm:text-3xl font-extrabold text-heading !leading-tight break-words">
              AI-Powered Solutions for Dermatology Clinics
            </p>
            <p className="md:text-xl text-base font-medium text-heading !leading-snug">
              Smlyx presents advanced AI-powered solutions tailored to
              {/* automate and elevate various facets of dermatology practices. Our
              tools deliver reliable insights, streamline operations, and
              enhance patient experiences, ultimately leading to improved
              outcomes. */}
            </p>
          </div>
